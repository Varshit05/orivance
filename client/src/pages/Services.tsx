  ...
  const text = (
    <div className="flex flex-col justify-center">
      ...
      {id === 'regulatory-resilience' && (
        <div className="mt-6">
          <Link
            to="/services/regulatory-resilience"
            className="inline-flex items-center gap-1.5 text-sm font-medium text-ov-blue transition-all duration-200 hover:gap-3 hover:text-ov-blue-light"
          >
